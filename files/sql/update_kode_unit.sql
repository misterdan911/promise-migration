...
UPDATE ref_unit_pbj SET kode_unit = 'UN31.LPPJJ1', kode_pbj = 'UN31.LPPJJ1', nama_unit='Pusat Produksi Bahan Ajar dan Multimedia', nama_pbj='Pusat Produksi Bahan Ajar dan Multimedia' WHERE kode_unit = 'UN31.LLOP1';
UPDATE ref_unit_pbj SET kode_unit = 'UN31.LPPJJ2', kode_pbj = 'UN31.LPPJJ2', nama_unit='Pusat Distribusi Bahan Ajar', nama_pbj='Pusat Distribusi Bahan Ajar' WHERE kode_unit = 'UN31.LLOP2';
UPDATE ref_unit_pbj SET kode_unit = 'UN31.LPPJJ3', kode_pbj = 'UN31.LPPJJ3', nama_unit='Pusat Pengelolaan Pembelajaran', nama_pbj='Pusat Pengelolaan Pembelajaran' WHERE kode_unit = 'UN31.LLOP3';
UPDATE ref_unit_pbj SET kode_unit = 'UN31.LPPJJ4', kode_pbj = 'UN31.LPPJJ4', nama_unit='Pusat Pengelolaan Ujian', nama_pbj='Pusat Pengelolaan Ujian' WHERE kode_unit = 'UN31.LLOP4';
...
INSERT INTO "public"."ref_unit_pbj_history" ("kode_history", "kode_unit_pbj", "kode_unit_old", "nama_unit_old", "kode_pbj_old", "nama_pbj_old", "kode_unit_new", "nama_unit_new", "kode_pbj_new", "nama_pbj_new") VALUES (4, 54, 'UN31.LLOP1', 'Pusat Produksi Bahan Ajar Multi Media', 'UN31.LLOP1', 'Pusat Produksi Bahan Ajar Multi Media', 'UN31.LPPJJ1', 'Pusat Produksi Bahan Ajar dan Multimedia', 'UN31.LPPJJ1', 'Pusat Produksi Bahan Ajar dan Multimedia');
INSERT INTO "public"."ref_unit_pbj_history" ("kode_history", "kode_unit_pbj", "kode_unit_old", "nama_unit_old", "kode_pbj_old", "nama_pbj_old", "kode_unit_new", "nama_unit_new", "kode_pbj_new", "nama_pbj_new") VALUES (5, 55, 'UN31.LLOP2', 'Pusat Layanan Bahan Ajar', 'UN31.LLOP2', 'Pusat Layanan Bahan Ajar', 'UN31.LPPJJ2', 'Pusat Distribusi Bahan Ajar', 'UN31.LPPJJ2', 'Pusat Distribusi Bahan Ajar');
INSERT INTO "public"."ref_unit_pbj_history" ("kode_history", "kode_unit_pbj", "kode_unit_old", "nama_unit_old", "kode_pbj_old", "nama_pbj_old", "kode_unit_new", "nama_unit_new", "kode_pbj_new", "nama_pbj_new") VALUES (6, 56, 'UN31.LLOP3', 'Pusat Pengelolaan Pembelajaran', 'UN31.LLOP3', 'Pusat Pengelolaan Pembelajaran', 'UN31.LPPJJ3', 'Pusat Pengelolaan Pembelajaran', 'UN31.LPPJJ3', 'Pusat Pengelolaan Pembelajaran');
INSERT INTO "public"."ref_unit_pbj_history" ("kode_history", "kode_unit_pbj", "kode_unit_old", "nama_unit_old", "kode_pbj_old", "nama_pbj_old", "kode_unit_new", "nama_unit_new", "kode_pbj_new", "nama_pbj_new") VALUES (7, 57, 'UN31.LLOP4', 'Pusat Pengolahan Pengujian', 'UN31.LLOP4', 'Pusat Pengolahan Pengujian', 'UN31.LPPJJ4', 'Pusat Pengelolaan Ujian', 'UN31.LPPJJ4', 'Pusat Pengelolaan Ujian');
...
UPDATE trx_user_tampung SET kode_unit = 'UN31.LPPJJ1', nama_unit='Pusat Produksi Bahan Ajar dan Multimedia' WHERE kode_unit = 'UN31.LLOP1';
UPDATE trx_user_tampung SET kode_unit = 'UN31.LPPJJ2', nama_unit='Pusat Distribusi Bahan Ajar' WHERE kode_unit = 'UN31.LLOP2';
UPDATE trx_user_tampung SET kode_unit = 'UN31.LPPJJ3', nama_unit='Pusat Pengelolaan Pembelajaran' WHERE kode_unit = 'UN31.LLOP3';
UPDATE trx_user_tampung SET kode_unit = 'UN31.LPPJJ4', nama_unit='Pusat Pengelolaan Ujian' WHERE kode_unit = 'UN31.LLOP4';
...
UPDATE ref_rup SET kode_unit = 'UN31.LPPJJ1' WHERE kode_unit = 'UN31.LLOP1';
UPDATE ref_rup SET kode_unit = 'UN31.LPPJJ2' WHERE kode_unit = 'UN31.LLOP2';
UPDATE ref_rup SET kode_unit = 'UN31.LPPJJ3' WHERE kode_unit = 'UN31.LLOP3';
UPDATE ref_rup SET kode_unit = 'UN31.LPPJJ4' WHERE kode_unit = 'UN31.LLOP4';
...
UPDATE trx_kategori SET kode_unit_pbj = 'UN31.LPPJJ1' WHERE kode_unit_pbj = 'UN31.LLOP1';
UPDATE trx_kategori SET kode_unit_pbj = 'UN31.LPPJJ2' WHERE kode_unit_pbj = 'UN31.LLOP2';
UPDATE trx_kategori SET kode_unit_pbj = 'UN31.LPPJJ3' WHERE kode_unit_pbj = 'UN31.LLOP3';
UPDATE trx_kategori SET kode_unit_pbj = 'UN31.LPPJJ4' WHERE kode_unit_pbj = 'UN31.LLOP4';
...
UPDATE trx_penjaringan SET kode_unit_pbj = 'UN31.LPPJJ1' WHERE kode_unit_pbj = 'UN31.LLOP1';
UPDATE trx_penjaringan SET kode_unit_pbj = 'UN31.LPPJJ2' WHERE kode_unit_pbj = 'UN31.LLOP2';
UPDATE trx_penjaringan SET kode_unit_pbj = 'UN31.LPPJJ3' WHERE kode_unit_pbj = 'UN31.LLOP3';
UPDATE trx_penjaringan SET kode_unit_pbj = 'UN31.LPPJJ4' WHERE kode_unit_pbj = 'UN31.LLOP4';
...
UPDATE ref_permintaan SET kode_unit = 'UN31.LPPJJ1' WHERE kode_unit = 'UN31.LLOP1';
UPDATE ref_permintaan SET kode_unit = 'UN31.LPPJJ2' WHERE kode_unit = 'UN31.LLOP2';
UPDATE ref_permintaan SET kode_unit = 'UN31.LPPJJ3' WHERE kode_unit = 'UN31.LLOP3';
UPDATE ref_permintaan SET kode_unit = 'UN31.LPPJJ4' WHERE kode_unit = 'UN31.LLOP4';
